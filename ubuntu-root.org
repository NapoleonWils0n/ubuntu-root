...
#+NAME: doas-root-dir
#+BEGIN_SRC conf :noweb yes :tangle "/sudo::/etc/doas.conf"
<<doas>>
#+END_SRC
...
#+BEGIN_SRC sh :noweb yes :tangle "/sudo::/usr/local/bin/blackrain" :tangle-mode (identity #o755)
<<blackrain>>
#+END_SRC
...
#+BEGIN_SRC sh :noweb yes :tangle "/sudo::/usr/local/bin/chromium-netns" :tangle-mode (identity #o755)
<<chromium-netns>>
#+END_SRC
...
#+BEGIN_SRC sh :noweb yes :tangle "/sudo::/usr/local/bin/firefox-netns" :tangle-mode (identity #o755)
<<firefox-netns>>
#+END_SRC
...
#+BEGIN_SRC sh :noweb yes :tangle "/sudo::/usr/local/bin/magnet-add" :tangle-mode (identity #o755)
<<magnet-add>>
#+END_SRC
...
#+BEGIN_SRC sh :noweb yes :tangle "/sudo::/usr/local/bin/namespace" :tangle-mode (identity #o755)
<<namespace>>
#+END_SRC
...
#+BEGIN_SRC sh :noweb yes :tangle "/sudo::/usr/local/bin/netns-vpn" :tangle-mode (identity #o755)
<<netns-vpn>>
#+END_SRC
...
#+BEGIN_SRC sh :noweb yes :tangle "/sudo::/usr/local/bin/nognome_notifications" :tangle-mode (identity #o755)
<<nognome_notifications>>
#+END_SRC
...
#+BEGIN_SRC sh :noweb yes :tangle "/sudo::/usr/local/bin/openvpn-down" :tangle-mode (identity #o755)
<<openvpn-down>>
#+END_SRC
...
#+BEGIN_SRC sh :noweb yes :tangle "/sudo::/usr/local/bin/openvpn-up" :tangle-mode (identity #o755)
<<openvpn-up>>
#+END_SRC
...
#+BEGIN_SRC sh :noweb yes :tangle "/sudo::/usr/local/bin/vpn-netns" :tangle-mode (identity #o755)
<<vpn-netns>>
#+END_SRC
...
#+BEGIN_SRC sh :noweb yes :tangle "/sudo::/usr/local/bin/vpn-route" :tangle-mode (identity #o755)
<<vpn-route>>
#+END_SRC
...
#+NAME: xorg-root-dir
#+BEGIN_SRC conf :noweb yes :tangle "/sudo::/etc/X11/xorg.conf.d/10-monitor.conf" :tangle-mode (identity #o644)
<<xorg>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/sudo::/usr/share/xsessions/xmonad.desktop" :tangle-mode (identity #o644)
<<xmonad-xsession>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/sudo::/usr/share/zsh/vendor-completions/_playerctl" :tangle-mode (identity #o644)
<<playerctl>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/sudo::/usr/share/zsh/vendor-completions/_yt-dlp" :tangle-mode (identity #o644)
<<yt-dlp>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/sudo::/etc/unbound/unbound.conf" :tangle-mode (identity #o644)
<<unbound.conf>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/sudo::/etc/unbound/unbound.conf.d/custom.conf" :tangle-mode (identity #o644)
<<custom.conf>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/sudo::/etc/unbound/unbound_ad_servers" :tangle-mode (identity #o644)
<<unbound_ad_servers>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/sudo::/etc/unbound/unbound_outgoing_interface" :tangle-mode (identity #o644)
...
#+BEGIN_SRC conf :noweb yes :tangle "/sudo::/etc/resolv.conf" :tangle-mode (identity #o644)
<<resolv>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/sudo::/etc/dhcp/dhclient.conf" :tangle-mode (identity #o644)
<<dhclient>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/sudo::/etc/dnscrypt-proxy/dnscrypt-proxy.toml" :tangle-mode (identity #o644)
<<dnscrypt-proxy>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/sudo::/etc/systemd/logind.conf" :tangle-mode (identity #o644)
<<logind>>
#+END_SRC
...
#+BEGIN_SRC conf :noweb yes :tangle "/sudo::/etc/systemd/system/dnscrypt-proxy.service" :tangle-mode (identity #o644)
...
#+BEGIN_SRC conf :noweb yes :tangle "/sudo::/etc/systemd/system/dnscrypt-proxy.socket" :tangle-mode (identity #o644)
...
#+BEGIN_SRC conf :noweb yes :tangle "/sudo::/etc/systemd/system/transmission.service.d/username.conf" :tangle-mode (identity #o644)
...
#+BEGIN_SRC conf :noweb yes :tangle "/sudo::/etc/systemd/system/unbound-netns.service" :tangle-mode (identity #o644)
